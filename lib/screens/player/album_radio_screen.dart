      ...
      child: Row(
        ...
        children: [
          GestureDetector(
            ...
            child: (isInShuffle)
                ? Image.asset(
                    'assets/images/icon_shuffle_on.png',
                    height: 22,
                    width: 22,
                  )
                : Image.asset(
                    'assets/images/icon_shuffle_off.png',
                    height: 22,
                    width: 22,
                  ),
          ),
          Image.asset('assets/images/icon_back_song.png'),
          GestureDetector(
            onTap: () {
              setState(() {
                isInPlay = !isInPlay;
          ...
          Image.asset('assets/images/icon_next_song.png'),
          GestureDetector(
            onTap: () {
              setState(() {
            ...
            child: (isInRepeat)
                ? Image.asset(
                    'assets/images/icon_repeat_on.png',
                    height: 29,
                    width: 29,
                  )
                : Image.asset(
                    'assets/images/icon_restart_off.png',
                    height: 29,
                    width: 29,
                  ),
          ),
        ...
        Row(
          children: [
            SizedBox(
              height: 46,
              width: 46,
              child: Image.asset('assets/images/home/AUSTIN.jpg'),
            ),
            const SizedBox(
              width: 10,
            ),
